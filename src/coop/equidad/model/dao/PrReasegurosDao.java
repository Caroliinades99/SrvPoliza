...
public class PrReasegurosDao {
	 ...
	 * @param w_valstring
	 */
	public Object spPrReaseguros(String w_sucur, String w_certif, String w_codpla, String w_tomador, 
			String w_fecini, String w_fecter, float w_comision, String w_user) {
		Object w_ind = null;

		em = emf.createEntityManager();
		 
		StoredProcedureQuery storedProcedure = em.createStoredProcedureQuery(CONSTANTES.PR_REASEGUROS);
