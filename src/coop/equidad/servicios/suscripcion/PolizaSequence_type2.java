 ...
 */
            ...
            /**
            *  PolizaSequence_type2 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class PolizaSequence_type2
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = PolizaSequence_type2
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PolizaSequence_type2",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PolizaSequence_type2",
                           xmlWriter);
                   }
                                                ...
                                                if (localDetalle[i] != null){
                                                 localDetalle[i].serialize(new javax.xml.namespace.QName("","detalle"),
                                                           xmlWriter);
                                                            ...
                                                            writeStartElement(null, "", "detalle", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static PolizaSequence_type2 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PolizaSequence_type2 object =
                new PolizaSequence_type2();
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list1.add(coop.equidad.servicios.suscripcion.Detalle.Factory.parse(reader));
                                                                }
