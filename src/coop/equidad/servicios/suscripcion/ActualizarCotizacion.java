...
/**
 * ActualizarCotizacion bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class ActualizarCotizacion implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.example.org/SrvPoliza/", "actualizarCotizacion", "ns1");
	...
	/**
	 * field for Detalle This was an Array!
	 */
	...
	public void addDetalle(coop.equidad.servicios.suscripcion.Detalle param) {
		...
		java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localDetalle);
		list.add(param);
		this.localDetalle = (coop.equidad.servicios.suscripcion.Detalle[]) list
				.toArray(new coop.equidad.servicios.suscripcion.Detalle[list.size()]);
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":actualizarCotizacion", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "actualizarCotizacion",
						xmlWriter);
			}
			...
			if (localDetalle != null) {
				for (int i = 0; i < localDetalle.length; i++) {
					if (localDetalle[i] != null) {
						localDetalle[i].serialize(new javax.xml.namespace.QName("", "detalle"), xmlWriter);
					} else {
	...
	public static class Factory {
		 ...
		 */
		public static ActualizarCotizacion parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			ActualizarCotizacion object = new ActualizarCotizacion();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"actualizarCotizacion".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (ActualizarCotizacion) coop.equidad.servicios.suscripcion.ExtensionMapper
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "sucur").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "sucur").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "sucur" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setSucur(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "codpla").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "codpla").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "codpla" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setCodpla(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "certif").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "certif").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "certif" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setCertif(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "detalle").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "detalle").equals(reader.getName())) {

					// Process the array and step past its final element's end.

					list5.add(coop.equidad.servicios.suscripcion.Detalle.Factory.parse(reader));
					...
					object.setDetalle(
							(coop.equidad.servicios.suscripcion.Detalle[]) org.apache.axis2.databinding.utils.ConverterUtil
									.convertToArray(coop.equidad.servicios.suscripcion.Detalle.class, list5));
