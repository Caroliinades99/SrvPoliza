 ...
 */
            ...
            /**
            *  PolizaSequence_type1 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class PolizaSequence_type1
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = PolizaSequence_type1
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PolizaSequence_type1",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PolizaSequence_type1",
                           xmlWriter);
                   }
                                                ...
                                                if (localTercero[i] != null){
                                                 localTercero[i].serialize(new javax.xml.namespace.QName("","tercero"),
                                                           xmlWriter);
                                                            ...
                                                            writeStartElement(null, "", "tercero", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static PolizaSequence_type1 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PolizaSequence_type1 object =
                new PolizaSequence_type1();
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list1.add(coop.equidad.servicios.suscripcion.Tercero.Factory.parse(reader));
                                                                }
