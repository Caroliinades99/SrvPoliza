 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static EmitirPoliza parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EmitirPoliza object =
                new EmitirPoliza();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"emitirPoliza".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EmitirPoliza)coop.equidad.servicios.suscripcion.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
