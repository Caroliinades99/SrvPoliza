...
public class CoberturaWS {
	 ...
	 * @return
	 */
	public static PolizaSequence_type0 coberturaEntityToWS ( List<OsCoberturaPz> osCoberturas) {
	 ...
	 * @return
	 */
	public static Cobertura[] getCoberturas( List<OsCoberturaPz> coberturas ) {
	 ...
	 * @return
	 */
	public static Cobertura getCobertura(OsCoberturaPz osCobertura) {
